      ...
      var{txtTitle,txtDescription,txtStatus}=this.state;
        ...
        <div className="panel-body">
          <form onSubmit={this.onSubmit}>
            ...
            <div className="form-group">
              <label>Mô tả :</label>
             <textarea  className="form-control" name='txtDescription' value={txtDescription} onChange={this.onChange}></textarea> 
            </div>
            <label>Trạng Thái :</label>
            <input type="text" className="form-control" name='txtStatus' value={txtStatus} onChange={this.onChange}/>
            <br />
